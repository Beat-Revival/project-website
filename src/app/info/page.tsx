    ...
    return(
        <BeatRevivalLayout>
            ...
            <p>
                ...
                A: We plan to eventually support everything (excluding Companion App). However, some features may be missing on the initial launch. You will be able to find out more in our Discord. 
            </p>
            <br/>
            <p>
